...
/** Forward declaration for IFTTT configuration class */
struct _zwp_ifttt_config;
/** IFTTT configuration type */
typedef struct _zwp_ifttt_config *zwp_ifttt_config_t;

/** Forward declaration for IFTTT class */
struct _zwp_ifttt;
/** IFTTT type */
typedef struct _zwp_ifttt *zwp_ifttt_t;
