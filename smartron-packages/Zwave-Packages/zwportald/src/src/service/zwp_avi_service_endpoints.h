...
*/
/**
 * @file    zwp_avi_service_endpoints.h
 *
 * @brief   Avro Interface service - Endpoints Portion
 * @details Handles endpoints portion of Avro Interface service parameters.
 *
 * @author  Kumara
 *
...
#ifndef ZWP_AVI_SERVICE_ENDPOINTS_H_
#define ZWP_AVI_SERVICE_ENDPOINTS_H_
 ...
 */
/**
 * @brief Get endpoint ID from endpoint service object
...
/**
 * @brief Get result free handler from endpoint service object
 * @param[in]     service_endpoint  Endpoint service object
...
/**
 * @brief Get next level (interface level) service object from a given endpoint service object
 * @param[in]     service_endpoint  Endpoint service object
 * @return        Next level (interface level) service object
 */
...
/**
 * @brief Execute a endpoint level portion of service
 * @param[in]     service_endpoint  Endpoint service object
...
/**
 * @brief Get fields from Avro value object for a endpoint service
 * @param[in]     service_endpoint  Endpoint service object
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_avro_value_of_field_endpoints(zwp_service_endpoints_t service_endpoint,
		const char *type_name, avro_value_t *arg_value_p);

/**
 * @brief Get arguments from Avro value object for a endpoint service
 * @param[in]     service_endpoint  Endpoint service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_service_arg_endpoints(zwp_service_endpoints_t service_endpoint,
		const char *type_name, avro_value_t *arg_value_p);
 ...
 * @note
 * @par
 * The caller should call zwp_avi_free_avi_service_endpoints() to free resources
 */
 ...
 * @param[in]     service_endpoint  Endpoint service object
 * @return        Nothing
 * @see zwp_avi_alloc_avi_service_endpoints
 */
...
zwp_status_t zwp_avi_set_avro_value_of_response_with_result_endpoints(zwp_service_endpoints_t service_endpoint,
		const char *type_name, avro_value_t *arg_value_p);
/** }@ */
#endif /* ZWP_AVI_SERVICE_ENDPOINTS_H_ */
