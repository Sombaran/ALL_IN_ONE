...
#ifndef ZWP_AVI_SERVICE_NODES_H_
#define ZWP_AVI_SERVICE_NODES_H_
...
/**
 * @brief Get result free handler from node service object
 * @param[in]     service_node      Node service object
...
/**
 * @brief Get next level (endpoint level) service object from a given node service object
 * @param[in]     service_node      Node service object
 * @return        Next level (endpoint level) service object
 */
...
/**
 * @brief Execute a node level portion of service
 * @param[in]     service_node      Node service object
...
/**
 * @brief Get fields from Avro value object for a node service
 * @param[in]     service_node      Node service object
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_avro_value_of_field_nodes(zwp_service_nodes_t service_node,
		const char *type_name, avro_value_t *arg_value_p);

/**
 * @brief Get arguments from Avro value object for a node service
 * @param[in]     service_node      Node service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_service_arg_nodes(zwp_service_nodes_t service_node,
		const char *type_name, avro_value_t *arg_value_p);

/**
 * @brief Allocate node level service object
 * @param[in]     service_common    Object representing items common across all levels
 * @param[in]     service_net       Network service object
 * @param[out]    service_node_p    Node service object
 * @retval        ZWP_STATUS_OK     Success
 * @retval        ZWP_STATUS_ERROR  Failure
 *
 * @note
 * @par
 * The caller should call zwp_avi_free_avi_service_nodes() to free resources
 */
...
/**
 * @brief Free node level service object
 * @param[in]     service_node      Node service object
 * @return        Nothing
 * @see zwp_avi_alloc_avi_service_nodes
 */
void zwp_avi_free_avi_service_nodes(zwp_service_nodes_t service_node);

/**
 * @brief Set fields of Avro value object from a node service
 * @param[in]     service_node      Node service object
 * @param[in]     type_name         Avro type name
 * @param[in]     arg_value_p       Avro value object for fields of the service
 * @retval        ZWP_STATUS_OK     Success
...
/**
 * @brief Set results of Avro value object from a node service
 * @param[in]     service_node      Node service object
 * @param[in]     type_name         Avro type name
...
zwp_status_t zwp_avi_set_avro_value_of_response_with_result_nodes(zwp_service_nodes_t service_node,
		const char *type_name, avro_value_t *arg_value_p);
/** }@ */
#endif /* ZWP_AVI_SERVICE_NODES_H_ */
