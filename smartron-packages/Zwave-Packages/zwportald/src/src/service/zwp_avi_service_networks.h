...
*/
/**
 * @file    zwp_avi_service_networks.h
 *
...
#ifndef ZWP_AVI_SERVICE_NETWORKS_H_
#define ZWP_AVI_SERVICE_NETWORKS_H_
...
/**
 * @brief Test if the network service execution must proceed only when the network is valid (initialized)
 * @param[in]     service_net       Network service object
 * @retval        0                 The service shall be executed irrespective of the validity (initialization state) of network.
 * @retval        1                 The service should be executed only when the network is valid (initialized)
 */
int                                   zwp_avi_service_networks_get_avi_message_networks_valid_network_check(zwp_service_networks_t service_net);
/**
 * @brief Get result free handler from network service object
 * @param[in]     service_net       Network service object
...
/**
 * @brief Get next level (node level) service object from a given network service object
 * @param[in]     service_net       Network service object
 * @return        Next level (node level) service object
 */
 ...
 */
/**
 * @brief Set network ID for a network service object
 * @param[in]     service_net       Network service object
...
/**
 * @brief Execute a network level portion of service
 * @param[in]     service_net       Network service object
...
/**
 * @brief Get fields from Avro value object for a network service
 * @param[in]     service_net       Network service object
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_avro_value_of_field_networks(zwp_service_networks_t service_net,
		const char *type_name, avro_value_t *arg_value_p);

/**
 * @brief Get arguments from Avro value object for a network service
 * @param[in]     service_net       Network service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_get_service_arg_networks(zwp_service_networks_t service_net,
		const char *type_name, avro_value_t *arg_value_p);

/**
 * @brief Allocate network level service object
 * @param[in]     service_common    Object representing items common across all levels
 * @param[out]    service_net_p     Network service object
 * @retval        ZWP_STATUS_OK     Success
 * @retval        ZWP_STATUS_ERROR  Failure
 *
 * @note
 * @par
 * The caller should call zwp_avi_free_avi_service_networks() to free resources
 */
zwp_status_t zwp_avi_alloc_avi_service_networks(zwp_service_common_t service_common, zwp_service_networks_t *service_net_p);

/**
 * @brief Free network level service object
 * @param[in]     service_net       Network service object
 * @return        Nothing
 * @see zwp_avi_alloc_avi_service_networks
 */
...
/**
 * @brief Set result of Avro value object from a network service
 * @param[in]     service_net       Network service object
 * @param[in]     type_name         Avro type name
...
zwp_status_t zwp_avi_set_avro_value_of_response_with_result_networks(zwp_service_networks_t service_net,
		const char *type_name, avro_value_t *arg_value_p);
/** }@ */
#endif /* ZWP_AVI_SERVICE_NETWORKS_H_ */
