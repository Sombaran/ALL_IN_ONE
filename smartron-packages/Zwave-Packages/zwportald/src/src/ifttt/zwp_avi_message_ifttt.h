...
#ifndef ZWP_AVI_MESSAGE_IFTTT_H_
#define ZWP_AVI_MESSAGE_IFTTT_H_
 ...
 */
typedef zwp_status_t (*zwp_avi_message_ifttt_execute_t)(zwp_net_t net, void *arg, void **result_p);

/** Forward declaration for 'AVI network message' class
 * @note    'zwp_avi_message_ifttt_t' is not a pointer
 */
typedef struct _zwp_avi_message_ifttt zwp_avi_message_ifttt_t;

/** AVI network message class */
struct _zwp_avi_message_ifttt
{
	...
	zwp_avi_message_ifttt_execute_t			  execute_handler;          /**< Execute handler */
 ...
 */
zwp_status_t zwp_avi_get_avi_message_ifttt_from_message_name(zwu_array_list_t message_list,
		const char *message_name, zwp_avi_message_ifttt_t **message_p);
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
zwp_status_t zwp_avi_message_list_add_message_ifttt(zwu_array_list_t message_list, zwp_avi_message_ifttt_t *message);
/** }@ */
#endif /* ZWP_AVI_MESSAGE_IFTTT_H_ */
