...
*/
/**
 * @file    zwu_http_client_manager.h
 *
...
#ifndef ZWU_HTTP_CLIENT_MANAGER_H_
#define ZWU_HTTP_CLIENT_MANAGER_H_
...
/**
 * @brief Process request. Thread safe.
 * @param[in]     http_client_manager        Http client manager object
 * @param[in]     request                    Request
 * @param[out]    manage_id_p                Manage ID
...
/**
 * @brief Close all the connection. Thread safe.
 * @param[in]     http_client_manager       Http client manager object
 * @retval        ZWU_STATUS_OK             Success
 * @retval        ZWU_STATUS_ERROR          Failure
 */
...
/**
 * @brief Create a http client manager object
 * @param[out]    http_client_manager_p     The new client manager object
 * @retval        ZWU_STATUS_OK             Success
 * @retval        ZWU_STATUS_ERROR          Failure
 */
...
/**
 * @brief Destroy http client manager object
 * @param[in]     http_client_manager       Http client manager object
 * @return        Nothing
 ...
 * @}
 */
#endif /* ZWU_HTTP_CLIENT_MANAGER_H_ */