...
*/
/**
 * @file    zwp_log_enable.h
 *
 * @brief   Logging enable.
 * @details Defines a set of macros to enable logging.
 *
 * @author  Kumara
 *
...
#ifndef ZWP_LOG_ENABLE_H_
#define ZWP_LOG_ENABLE_H_

#undef ZWP_LOG_DEBUG_IS_ENABLED
#undef ZWP_LOG_ZWP_LOG_DEBUG
#undef ZWP_LOG_DUMP_ZWP_LOG_DEBUG
