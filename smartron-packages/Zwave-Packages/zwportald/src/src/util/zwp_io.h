...
#define ZWP_FILE_READ_DEFAULT_BLOCK_SIZE       128
 ...
 * @note
 * @par
 * The caller should call zwp_read_free() to free resources
 *
 * @par
 ...
 * @return        Nothing
 * @see zwp_read_from_FILE_with_dest_alloc, zwp_read_from_file_path_with_dest_alloc
 */
void zwp_read_dest_free(char *dest);

/**
 * @brief Write a buffered data into a file given by its FILE pointer
 * @param[in]     file              FILE pointer
 * @param[in]     src               Source buffer
 * @param[in]     length            Source buffer size
 * @retval        ZWP_STATUS_OK     Success
 * @retval        ZWP_STATUS_ERROR  Failure
 */
...
/**
 * @brief Write a buffered data into a file given by its file path
 * @param[in]     path              File path
 * @param[in]     src               Source buffer
 * @param[in]     length            Source buffer size
 * @retval        ZWP_STATUS_OK     Success
