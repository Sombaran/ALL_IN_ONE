...
*/
/**
 * @file    zwp_avi_interfaces_thermostat_mode.c
 *
 * @brief   AVI message 'interface_thermostat_mode_xxx'
 * @details Handles the AVI message 'interface_thermostat_mode_xxx'.
 *
 * @author  Sasidhar
 *
 ...
 * @note
 * @par
 * The caller should call zwp_avi_interfaces_thermostat_mode_state_free() to free resources
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_state_alloc(void **state_p, zwp_pool_t pool)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;

	if ((state = (zwp_avi_interfaces_thermostat_mode_state_t *)ZWP_CALLOC(1, sizeof(*state))) == NULL)
	{
 ...
 * @return        Nothing
 * @see zwp_avi_interfaces_thermostat_mode_state_alloc
 */
static void zwp_avi_interfaces_thermostat_mode_state_free(void *arg)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;

	state = (zwp_avi_interfaces_thermostat_mode_state_t *)arg;
 ...
 * @return        Nothing
 */
static void zwp_avi_interfaces_thermostat_mode_report_handler(zwifd_p ifd, uint8_t mode, time_t ts)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_setup(zwifd_p desc_interface, int *hcapi_code_p)
{
	*hcapi_code_p = zwif_thrmo_md_rpt_set(desc_interface, zwp_avi_interfaces_thermostat_mode_report_handler);
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_get_report_receive_assertion(zwifd_p desc_interface, void *args,
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_get_execute_active(zwifd_p desc_interface, void *args, int *hcapi_code_p)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
	...
	*hcapi_code_p = zwif_thrmo_md_get(desc_interface, ZWIF_GET_BMSK_LIVE | ZWIF_GET_BMSK_CACHE);
 ...
 * @note
 * @par
 * The caller should call zwp_avi_interfaces_thermostat_mode_get_result_free() to free resources
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_get_execute_passive(zwifd_p desc_interface, void *args, void **result_p)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
	zwp_avi_interfaces_thermostat_mode_report_t *report;
	...
	if ((report = (zwp_avi_interfaces_thermostat_mode_report_t *)ZWP_CALLOC(1, sizeof(*report))) == NULL)
	{
		ZWP_LOG(ZWP_LOG_ERR, ZWP_MSG_MALLOC_FAILED);
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_get_result(void *result, avro_value_t *arg_value)
{
	zwp_avi_interfaces_thermostat_mode_report_t *report;

	report = (zwp_avi_interfaces_thermostat_mode_report_t *)result;
 ...
 * @param[in]     result            Result object
 * @return        Nothing
 * @see zwp_avi_interfaces_thermostat_mode_get_execute_passive
 */
static void zwp_avi_interfaces_thermostat_mode_get_result_free(void *result)
{
	ZWP_FREE(result);
}
 ...
 * @return        Nothing
 */
void zwp_avi_interfaces_thermostat_mode_supported_report_handler(zwifd_p ifd, uint8_t mode_len, uint8_t *mode, int valid)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
	zwifd_p desc_interface;
	uint8_t *tmp;
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_supported_get_report_receive_assertion(zwifd_p desc_interface, void *args,
		zwp_thread_cond_t *report_receive_condition_p)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_supported_get_execute_active(zwifd_p desc_interface, void *args, int *hcapi_code_p)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
	...
	*hcapi_code_p = zwif_thrmo_md_sup_get(desc_interface, zwp_avi_interfaces_thermostat_mode_supported_report_handler, 0);
 ...
 * @note
 * @par
 * The caller should call zwp_avi_interfaces_thermostat_mode_supported_get_result_free() to free resources
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_supported_get_execute_passive(zwifd_p desc_interface, void *args, void **result_p)
{
	zwp_avi_interfaces_thermostat_mode_state_t *state;
	zwp_avi_interfaces_thermostat_mode_supported_report_t *sup_report;
	...
	if ((sup_report = (zwp_avi_interfaces_thermostat_mode_supported_report_t *)ZWP_CALLOC(1, sizeof(*sup_report))) == NULL)
	{
		ZWP_LOG(ZWP_LOG_ERR, ZWP_MSG_MALLOC_FAILED);
		goto l_err_report_alloc;
	}
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_supported_get_result(void *result, avro_value_t *arg_value)
{
	zwp_avi_interfaces_thermostat_mode_supported_report_t *report;
	int32_t i=0;
	avro_value_t sup_modes_list_value;
	avro_value_t mode_element;

	report = (zwp_avi_interfaces_thermostat_mode_supported_report_t *)result;
 ...
 * @param[in]     result            Result object
 * @return        Nothing
 * @see zwp_avi_interfaces_thermostat_mode_supported_get_execute_passive
 */
static void zwp_avi_interfaces_thermostat_mode_supported_get_result_free(void *result)
{
	zwp_avi_interfaces_thermostat_mode_supported_report_t *sup_report;

	sup_report = (zwp_avi_interfaces_thermostat_mode_supported_report_t *)result;
 ...
 * @note
 * @par
 * The caller should call zwp_avi_interfaces_thermostat_mode_set_argument_free() to free resources
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_set_argument(avro_value_t *arg_value, void **args_p)
{
	zwp_avi_interfaces_thermostat_mode_set_t *argument;
	int integer;

	if ((argument = (zwp_avi_interfaces_thermostat_mode_set_t *)ZWP_MALLOC(sizeof(*argument))) == NULL)
	{
		ZWP_LOG(ZWP_LOG_ERR, ZWP_MSG_MALLOC_FAILED);
 ...
 * @return        Nothing
 * @see zwp_avi_interfaces_thermostat_mode_set_argument
 */
static void zwp_avi_interfaces_thermostat_mode_set_argument_free(void *args)
{
	ZWP_FREE(args);
}
 ...
 * @retval        ZWP_STATUS_ERROR  Failure
 */
static zwp_status_t zwp_avi_interfaces_thermostat_mode_set_execute_active(zwifd_p desc_interface, void *args, int *hcapi_code_p)
{
	zwp_avi_interfaces_thermostat_mode_set_t *argument;

	argument = (zwp_avi_interfaces_thermostat_mode_set_t *)args;

	*hcapi_code_p = zwif_thrmo_md_set(desc_interface, argument->mode);

	return ZWP_STATUS_OK;
}

/** Handlers for Get command */
static zwp_avi_message_interfaces_t interfaces_thermostat_mode_get =
{
		"interface_thermostat_mode_get",
		COMMAND_CLASS_THERMOSTAT_MODE, zwp_avi_interfaces_thermostat_mode_setup,
		zwp_avi_interfaces_thermostat_mode_state_alloc, zwp_avi_interfaces_thermostat_mode_state_free,
		NULL, NULL,
		zwp_avi_interfaces_thermostat_mode_get_report_receive_assertion,
		zwp_avi_interfaces_thermostat_mode_get_execute_active, zwp_avi_interfaces_thermostat_mode_get_execute_passive,
		zwp_avi_interfaces_thermostat_mode_get_result, zwp_avi_interfaces_thermostat_mode_get_result_free
};

/** Handlers for Set command */
static zwp_avi_message_interfaces_t interfaces_thermostat_mode_set =
{
		"interface_thermostat_mode_set",
		COMMAND_CLASS_THERMOSTAT_MODE, NULL,
		NULL, NULL,
		zwp_avi_interfaces_thermostat_mode_set_argument, zwp_avi_interfaces_thermostat_mode_set_argument_free,
		NULL,
		zwp_avi_interfaces_thermostat_mode_set_execute_active, NULL,
		NULL, NULL
};

/** Handlers for Supported Get command */
static zwp_avi_message_interfaces_t interfaces_thermostat_mode_supported_get =
{
		"interface_thermostat_mode_supported_get",
		COMMAND_CLASS_THERMOSTAT_MODE, NULL,
		NULL, NULL,
		NULL, NULL,
		zwp_avi_interfaces_thermostat_mode_supported_get_report_receive_assertion,
		zwp_avi_interfaces_thermostat_mode_supported_get_execute_active, zwp_avi_interfaces_thermostat_mode_supported_get_execute_passive,
		zwp_avi_interfaces_thermostat_mode_supported_get_result, zwp_avi_interfaces_thermostat_mode_supported_get_result_free
};

/** Register command handlers */
zwp_status_t zwp_avi_interfaces_thermostat_mode_init(zwu_array_list_t message_list)
{
	if ((zwp_avi_message_list_add_message_interfaces(message_list, &interfaces_thermostat_mode_get) != ZWP_STATUS_OK)
		||(zwp_avi_message_list_add_message_interfaces(message_list, &interfaces_thermostat_mode_supported_get) != ZWP_STATUS_OK)
		||(zwp_avi_message_list_add_message_interfaces(message_list, &interfaces_thermostat_mode_set) != ZWP_STATUS_OK))
	{
