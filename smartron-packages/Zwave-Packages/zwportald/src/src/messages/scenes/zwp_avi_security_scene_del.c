...
*/
/**
 * @file    zwp_avi_security_scene_del.c
 *
...
/**
zwp_avi_security_scene_del_execute - Invoke library function to execute request
@param[in]	net	            Network
@param[in]	arg	            Parameters
@param[out]	result_p	    Result of the execution
@return ZWP_STATUS_XXX
*/
static zwp_status_t zwp_avi_security_scene_del_execute(zwp_net_t net, void *arg, void **result_p)
{
    ...
    *result_p = NULL;
    ...
    ZWP_LOG(ZWP_LOG_DEBUG, "Execute - security_scene_del");
    ...
    //Delete scene
    if (zwscn_del_security_scene(net, *scene_id) != ZWSCN_ERR_NONE)
    {
...
static zwp_avi_message_networks_t security_scene_del =
{
    "security_scene_del",								/**< AVRO message name*/
...
/**
zwp_avi_security_scene_del_init - Scene delete initialization
@param[in]	message_list	    Message list
@return ZWP_STATUS_XXX
*/
zwp_status_t zwp_avi_security_scene_del_init(zwu_array_list_t message_list)
{
    if (zwp_avi_message_list_add_message_networks(message_list, &security_scene_del) != ZWP_STATUS_OK)
    {
        return ZWP_STATUS_ERROR;
    }
