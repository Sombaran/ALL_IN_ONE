...
*/
/**
 * @file    zwp_avi_ifttt_dlock.c
 *
 * @brief   AVI message 'ifttt_dlock'
 * @details Handles the AVI message 'ifttt_dlock'.
 *
 * @author  Angela Yan
 *
...
#include "zwp_avi_interfaces_door_lock.h"
 ...
 /** dlock option argument */
typedef struct {
	int					mode;
	eifttt_fields		efield;
} zwp_avi_ifttt_dlock_option_t;

 /**
 * @brief Get argument for dlock option operation from Avro value object
 ...
 */
static zwp_status_t zwp_avi_ifttt_dlock_option_argument(avro_value_t *arg_value, void **args_p)
{
	zwp_avi_ifttt_dlock_option_t *argument;
	int32_t ifield;

	if ((argument = (zwp_avi_ifttt_dlock_option_t *)ZWP_MALLOC(sizeof(*argument))) == NULL)
	{
...
/**
* @brief Free arguments for dlock option operation
* @param[in]     args              Arguments passed with Remove Failed Node operation
* @return        Nothing
* @see zwp_avi_networks_failed_node_remove_argument
*/
static void zwp_avi_ifttt_dlock_option_argument_free(void *args)
{
	ZWP_FREE(args);
}

/**
 * @brief Execute call to dlock option operation status
 ...
 *@note
 * @par
 * The caller should call zwp_avi_ifttt_dlock_get_result_free() to free resources
 */
static zwp_status_t zwp_avi_ifttt_dlock_option_execute(zwp_net_t net, void *arg, void **result_p)
{
	//zwp_status_t res = ZWP_STATUS_ERROR;
	zwp_avi_ifttt_dlock_option_t *argument;
	zwp_desc_net_t desc_net;
	zwu_array_list_t if_ep_name_list;
	uint16_t interfaceid = COMMAND_CLASS_DOOR_LOCK;

	argument = (zwp_avi_ifttt_dlock_option_t *)arg;
 ...
 * @return        Nothing
 * @see zwp_avi_ifttt_dlock_get_execute
 */
static void zwp_avi_ifttt_dlock_option_result_free(void *result)
{
	zwp_desc_free_if_ep_name_list(result);
}

/**
* @brief Get argument for dlock set operation from Avro value object
* @param[in]     arg_value         Avro value object
* @param[out]    args_p            Arguments passed with Node Add operation
* @retval        ZWP_STATUS_OK     Success
* @retval        ZWP_STATUS_ERROR  Failure
...
* The caller should call zwp_avi_networks_node_add_argument_free() to free resources
*/
static zwp_status_t zwp_avi_ifttt_dlock_set_argument(avro_value_t *arg_value, void **args_p)
{
...
/**
* @brief Free arguments for dlock set operation
* @param[in]     args              Arguments passed with Remove Failed Node operation
* @return        Nothing
* @see zwp_avi_networks_failed_node_remove_argument
*/
static void zwp_avi_ifttt_dlock_set_argument_free(void *args)
{
	ZWP_FREE(args);
}
...
* @retval        ZWP_STATUS_ERROR  Failure
*/
static zwp_status_t zwp_avi_ifttt_dlock_set_execute_active(zwifd_p desc_interface, void *args, int *hcapi_code_p)
{
	zwp_avi_interfaces_door_lock_operation_set_t *argument;
...
*/
static zwp_status_t zwp_avi_ifttt_dlock_set_execute_passive(zwifd_p desc_interface, void *args, void **result_p)
{
	zwp_avi_interfaces_door_lock_state_t *state;
	zwp_avi_ifttt_dlock_set_result_t *set_result;
	...
	if ((set_result = (zwp_avi_ifttt_dlock_set_result_t *)ZWP_CALLOC(1, sizeof(*set_result))) == NULL)
	{
		ZWP_LOG(ZWP_LOG_ERR, ZWP_MSG_MALLOC_FAILED);
...
* @retval        ZWP_STATUS_ERROR  Failure
*/
static zwp_status_t zwp_avi_ifttt_dlock_set_result(void *result, avro_value_t *arg_value)
{
	zwp_avi_ifttt_dlock_set_result_t *set_result;

	set_result = (zwp_avi_ifttt_dlock_set_result_t *)result;
...
*/
static void zwp_avi_ifttt_dlock_set_result_free(void *result)
{
	ZWP_FREE(result);
}

/** Handlers for getting dlock option */
static zwp_avi_message_networks_t ifttt_dlock_option =
{
	"ifttt_network_dlock_option",
	zwp_avi_ifttt_dlock_option_argument, zwp_avi_ifttt_dlock_option_argument_free,
	zwp_avi_ifttt_dlock_option_execute, ZWP_AVI_MESSAGE_VALID_NETWORK_CHECK_YES,
	zwp_avi_ifttt_device_name_option_result, zwp_avi_ifttt_dlock_option_result_free
};

/** Handlers for dlock Set command (interface leel) */
static zwp_avi_message_interfaces_t ifttt_interfaces_dlock_set =
{
	"ifttt_interface_dlock_set",
	COMMAND_CLASS_DOOR_LOCK, NULL,
	NULL, NULL,
	zwp_avi_ifttt_dlock_set_argument, zwp_avi_ifttt_dlock_set_argument_free,
	NULL,
	zwp_avi_ifttt_dlock_set_execute_active, zwp_avi_ifttt_dlock_set_execute_passive,
	zwp_avi_ifttt_dlock_set_result, zwp_avi_ifttt_dlock_set_result_free
};

/** Register handlers */
zwp_status_t zwp_avi_ifttt_dlock_init(zwu_array_list_t network_message_list, zwu_array_list_t interface_message_list)
{
	if ((zwp_avi_message_list_add_message_networks(network_message_list, &ifttt_dlock_option) != ZWP_STATUS_OK) ||
		(zwp_avi_message_list_add_message_interfaces(interface_message_list, &ifttt_interfaces_dlock_set)))
	{
		goto l_err_dlock_option;
	}
