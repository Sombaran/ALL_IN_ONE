...
*/
/**
 * @file    zws_avi_endpoints_node_naming.c
 *
...
/** Node Naming Name Location Set */
#define COMMAND_NODE_NAMING_NAME_LOCATION_SET              1

/**
 * @brief Set Avro value for RPC request for Name Location Set command using CGI request arguments
 ...
 */
static zws_status_t zws_avi_endpoints_node_naming_name_location_set_argument(char *(*args)[2], int args_count, avro_value_t *arg_value_p)
{
...
static zws_avi_message_endpoints_t endpoints_node_naming_name_location_set =
{
		{"zwep_nameloc", "naming"}, COMMAND_NODE_NAMING_NAME_LOCATION_SET,

		"endpoint_node_naming_name_location_set",

		zws_avi_endpoints_node_naming_name_location_set_argument,
		NULL,
...
{
	if (zws_avi_message_list_add_message_endpoints(message_list, &endpoints_node_naming_name_location_set) != ZWS_STATUS_OK)
	{
