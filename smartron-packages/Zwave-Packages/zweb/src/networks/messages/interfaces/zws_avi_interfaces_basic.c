...
*/
/**
 * @file    zws_avi_interfaces_basic.c
 *
...
/** Basic Setup */
#define COMMAND_BASIC_SETUP              1
/** Basic Get */
#define COMMAND_BASIC_GET                2
/** Basic Report */
#define COMMAND_BASIC_REPORT             3
/** Basic Set */
#define COMMAND_BASIC_SET                4
 ...
 */
static zws_status_t zws_avi_interfaces_basic_get_result(int web_api_version, unsigned long combo_id, avro_value_t *arg_value, zwu_string_buffer_t result)
{
	int64_t utime;
	int32_t value;
	...
	if (zwu_string_buffer_append_format(result,
			"<%s %s=\"%llu\" state=\"%u\" />",
			((web_api_version == ZWS_WEB_API_VERSION_1) ? "basic" : "basic"),
 ...
 * @retval        ZWS_STATUS_ERROR  Failure
 */
static zws_status_t zws_avi_interfaces_basic_set_argument(char *(*args)[2], int args_count, avro_value_t *arg_value_p)
{
...
static zws_avi_message_interfaces_t interfaces_basic_get =
{
		{"zwif_basic", "basic"}, COMMAND_BASIC_GET,
		...
		NULL,
		zws_avi_interfaces_basic_get_result,

		"tServBasic"
};

/** Handlers for Set command */
static zws_avi_message_interfaces_t interfaces_basic_set =
{
		{"zwif_basic", "basic"}, COMMAND_BASIC_SET,
		ZWS_AVI_MESSAGE_PASSIVE_NOT_SUPPORTED,
		ZWS_AVI_MESSAGE_SETUP_SUPPORTED,

		"interface_basic_set",

		zws_avi_interfaces_basic_set_argument,
		NULL,
...
{
	if ((zws_avi_message_list_add_message_interfaces(message_list, &interfaces_basic_get) != ZWS_STATUS_OK)
			|| (zws_avi_message_list_add_message_interfaces(message_list, &interfaces_basic_set) != ZWS_STATUS_OK))
	{
