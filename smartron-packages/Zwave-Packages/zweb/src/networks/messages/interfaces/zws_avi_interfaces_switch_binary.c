...
*/
/**
 * @file    zws_avi_interfaces_switch_binary.c
 *
...
/** Switch Binary Setup */
#define COMMAND_SWITCH_BINARY_SETUP              1
/** Switch Binary Get */
#define COMMAND_SWITCH_BINARY_GET                2
/** Switch Binary Report */
#define COMMAND_SWITCH_BINARY_REPORT             3
/** Switch Binary Set */
#define COMMAND_SWITCH_BINARY_SET                4
 ...
 */
static zws_status_t zws_avi_interfaces_switch_binary_get_result(int web_api_version, unsigned long combo_id, avro_value_t *arg_value, zwu_string_buffer_t result)
{
	int64_t utime;
	int32_t value;
	...
	if (zwu_string_buffer_append_format(result,
			"<%s %s=\"%llu\" state=\"%u\" />",
			((web_api_version == ZWS_WEB_API_VERSION_1) ? "bin_sw" : "switch"),
 ...
 * @retval        ZWS_STATUS_ERROR  Failure
 */
static zws_status_t zws_avi_interfaces_switch_binary_set_argument(char *(*args)[2], int args_count, avro_value_t *arg_value_p)
{
...
static zws_avi_message_interfaces_t interfaces_switch_binary_get =
{
		{"zwif_switch", "bin_sw"}, COMMAND_SWITCH_BINARY_GET,
		...
		NULL,
		zws_avi_interfaces_switch_binary_get_result,

		"tServBinSw"
};

/** Handlers for Set command */
static zws_avi_message_interfaces_t interfaces_switch_binary_set =
{
		{"zwif_switch", "bin_sw"}, COMMAND_SWITCH_BINARY_SET,
		ZWS_AVI_MESSAGE_PASSIVE_NOT_SUPPORTED,
		ZWS_AVI_MESSAGE_SETUP_SUPPORTED,

		"interface_switch_binary_set",

		zws_avi_interfaces_switch_binary_set_argument,
		NULL,
...
{
	if ((zws_avi_message_list_add_message_interfaces(message_list, &interfaces_switch_binary_get) != ZWS_STATUS_OK)
			|| (zws_avi_message_list_add_message_interfaces(message_list, &interfaces_switch_binary_set) != ZWS_STATUS_OK))
	{
