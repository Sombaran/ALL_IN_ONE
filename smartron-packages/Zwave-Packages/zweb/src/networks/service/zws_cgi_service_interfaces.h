...
*/
/**
 * @file    zws_cgi_service_interfaces.h
 *
 * @brief   CGI Input - Interfaces Portion
...
#ifndef ZWS_CGI_SERVICE_INTERFACES_H_
#define ZWS_CGI_SERVICE_INTERFACES_H_
...
typedef struct _zws_service_interfaces *zws_service_interfaces_t;

/**
 * @brief Set fields of Avro value object for a interface service
...
/**
 * @brief Set arguments of Avro value object for a interface service
 * @param[in]     service_interface Interface Service object
 * @param[in]     type_name         Avro type name
 ...
 * @note
 * @par
 * The caller should call zws_cgi_free_cgi_service_interfaces_from_environment() to free resources
 */
 ...
 * @param[in]     service_interface Interface Service object
 * @return        Nothing
 * @see zws_cgi_get_cgi_service_interfaces_from_environment
 */
void zws_cgi_free_cgi_service_interfaces_from_environment(zws_service_interfaces_t service_interface);

/**
 * @brief Get result from Avro value object for a interface service
 * @param[in]     service_interface Interface Service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWS_STATUS_ERROR  Failure
 */
zws_status_t zws_cgi_set_service_result_interfaces(zws_service_interfaces_t service_interface,
		const char *type_name, avro_value_t *result_value_p);

/**
 * @brief Send CGI output for a interface service
 * @param[in]     service_interface Interface Service object
 * @retval        ZWS_STATUS_OK     Success
 * @retval        ZWS_STATUS_ERROR  Failure
 */
...
/** }@ */
#endif /* ZWS_CGI_SERVICE_INTERFACES_H_ */
