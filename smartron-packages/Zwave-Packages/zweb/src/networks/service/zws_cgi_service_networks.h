...
*/
/**
 * @file    zws_cgi_service_networks.h
 *
 * @brief   CGI Input - Networks Portion
...
#ifndef ZWS_CGI_SERVICE_NETWORKS_H_
#define ZWS_CGI_SERVICE_NETWORKS_H_
...
/** Forward declaration for CGI service class for networks */
struct _zws_service_networks;

/** Network service class */
typedef struct _zws_service_networks *zws_service_networks_t;

/**
 * @brief Set fields of Avro value object for a network service
...
/**
 * @brief Set arguments of Avro value object for a network service
 * @param[in]     service_net       Network service object
 * @param[in]     type_name         Avro type name
 ...
 * @param[in]     service_net       Network service object
 * @return        Nothing
 * @see zws_cgi_get_cgi_service_networks_from_environment
 */
void zws_cgi_free_cgi_service_networks_from_environment(zws_service_networks_t service_net);

/**
 * @brief Get result from Avro value object for a network service
 * @param[in]     service_net       Network service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWS_STATUS_ERROR  Failure
 */
zws_status_t zws_cgi_set_service_result_networks(zws_service_networks_t service_net,
		const char *type_name, avro_value_t *result_value_p);

/**
 * @brief Send CGI output for a network service
 * @param[in]     service_net       Network service object
 * @retval        ZWS_STATUS_OK     Success
 * @retval        ZWS_STATUS_ERROR  Failure
 */
...
/** }@ */
#endif /* ZWS_CGI_SERVICE_NETWORKS_H_ */
