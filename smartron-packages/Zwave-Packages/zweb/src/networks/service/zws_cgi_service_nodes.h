...
*/
/**
 * @file    zws_cgi_service_nodes.h
 *
 * @brief   CGI Input - Nodes Portion
...
#ifndef ZWS_CGI_SERVICE_NODES_H_
#define ZWS_CGI_SERVICE_NODES_H_
...
/** Forward declaration for CGI service class for nodes */
struct _zws_service_nodes;

/** Node Service class */
typedef struct _zws_service_nodes *zws_service_nodes_t;

/**
 * @brief Set fields of Avro value object for a node service
...
/**
 * @brief Set arguments of Avro value object for a node service
 * @param[in]     service_node      Node Service object
 * @param[in]     type_name         Avro type name
 ...
 * @note
 * @par
 * The caller should call zws_cgi_free_cgi_service_nodes_from_environment() to free resources
 */
 ...
 * @param[in]     service_node      Node Service object
 * @return        Nothing
 * @see zws_cgi_get_cgi_service_nodes_from_environment
 */
void zws_cgi_free_cgi_service_nodes_from_environment(zws_service_nodes_t service_node);

/**
 * @brief Get result from Avro value object for a node service
 * @param[in]     service_node      Node Service object
 * @param[in]     type_name         Avro type name
 ...
 * @retval        ZWS_STATUS_ERROR  Failure
 */
zws_status_t zws_cgi_set_service_result_nodes(zws_service_nodes_t service_node,
		const char *type_name, avro_value_t *result_value_p);

/**
 * @brief Send CGI output for a node service
 * @param[in]     service_node      Node Service object
 * @retval        ZWS_STATUS_OK     Success
 * @retval        ZWS_STATUS_ERROR  Failure
 */
...
/** }@ */
#endif /* ZWS_CGI_SERVICE_NODES_H_ */
