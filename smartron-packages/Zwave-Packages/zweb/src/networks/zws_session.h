...
#ifndef ZWS_SESSION_H_
#define ZWS_SESSION_H_

#include "zws_status.h"
#include "zws_memcache.h"

/** Forward declaration for Session class */
struct _zws_session;
/** Session type */
typedef struct _zws_session *zws_session_t;
...
/**
 * @brief Allocate and initialize a new session object
 * @param[out]    session_p         Session object
 ...
 * @note
 * @par
 * The caller should call zws_session_exit() to free resources
 */
zws_status_t zws_session_init(zws_session_t *session_p, zws_memcache_t memcache);

/**
 * @brief Free session object
 * @param[in]     session           Session object
 * @return        Nothing
 * @see zws_session_init
 */
void zws_session_exit(zws_session_t session);

#endif /* ZWS_SESSION_H_ */
