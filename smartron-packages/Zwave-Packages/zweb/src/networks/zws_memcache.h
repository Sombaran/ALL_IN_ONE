...
#ifndef ZWS_MEMCACHE_H_
#define ZWS_MEMCACHE_H_

#include "zws_status.h"

/** Forward declaration for Memcache class */
struct _zws_memcache;
/** Memcache type */
typedef struct _zws_memcache *zws_memcache_t;

/**
 * @brief Get user name for a given session ID
 * @param[in]     memcache          Memcache object
...
/**
 * @brief Set user name for a given session ID
 * @param[in]     memcache          Memcache object
 * @param[in]     session_id        Session ID
 * @param[out]    user_name         User name
 * @retval        ZWS_STATUS_OK     Success
 * @retval        ZWS_STATUS_ERROR  Failure
 */
...
/**
 * @brief Allocate and initialize a new memcache object
 * @param[out]    memcache_p        Memcache object
 * @retval        ZWS_STATUS_OK     Success
 * @retval        ZWS_STATUS_ERROR  Failure
 *
 * @note
 * @par
 * The caller should call zws_memcache_exit() to free resources
 */
zws_status_t zws_memcache_init(zws_memcache_t *memcache_p);

/**
 * @brief Free memcache object
 * @param[in]     memcache          Memcache object
 * @return        Nothing
 * @see zws_memcache_init
 */
void zws_memcache_exit(zws_memcache_t memcache);

#endif /* ZWS_MEMCACHE_H_ */
