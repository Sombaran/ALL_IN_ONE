...
*/
#ifndef _ZWSCN_SCENE_EVENTS_H_
#define _ZWSCN_SCENE_EVENTS_H_

/** @defgroup GroupPrivateSceneEvents Scenes Event functions
 *  Functions for processing Scene Event trigger
 *  @ingroup GroupPrivateGeneral
 */
///@{

/**
 * @brief	Thread for receiving Device Reports for Scene Events
...
/**
 * @brief	Function to process Device Reports for Scene Events
...
/**
 * @brief	Function to execute a Scene on Scene Event trigger based on Device Report
 * @param[in] net		Network runtime context
