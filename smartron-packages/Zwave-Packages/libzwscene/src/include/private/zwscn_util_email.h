...
*/
#ifndef _ZWSCN_UTIL_EMAIL_H_
#define _ZWSCN_UTIL_EMAIL_H_

/** @defgroup GroupPrivateUtilsEmail Email utils
 *  Utility functions for email support
 ...
 * @param[in] to		Email address of receiver
 * @param[in] from		Email address of sender
 * @param[in] subject	Email subject
 * @param[in] message	Email body
