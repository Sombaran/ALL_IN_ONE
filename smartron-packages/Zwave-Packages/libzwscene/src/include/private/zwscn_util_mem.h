...
*/
#ifndef _ZWSCN_UTIL_MEM_H_
#define _ZWSCN_UTIL_MEM_H_

/** @defgroup GroupPrivateUtilMem Memory utils
 *  Utility functions for handling/freeing memory
 *  @ingroup GroupPrivateUtils
 */
///@{

/**
 * @brief	Free Device Report Cache
 * @param[in] init_data_ptr	Init data poniter
 */
void zwscn_free_hash_device_report_cache(void *init_data_ptr);
/**
 * @brief	Foreach-loop callback for @ref zwscn_hash_foreach_remove function
 * @param[in] net 		Network runtime context
 * @param[in] init_data	Init data
 * @param[in] user_data	User data
 * @return	  TRUE (removes key-value pair from hash)
 */
int zwscn_free_net_foreach_callback(void *net, void *init_data, void *user_data);
/**
 * @brief	Free Network
 * @param[in] init_data_ptr	Init data
 */
void zwscn_free_net(void *init_data_ptr);
/**
 * @brief	Free Init data
 * @param[in] init_data_ptr	Init data
 */
void zwscn_free_init_data(void *init_data_ptr);
/**
 * @brief	Free a new Scene structure
