...
*/
/**
@file		zwscn_device_report_cache.h  
  
                Header for functions for caching the timestamp of the last received device report
...
*/
#ifndef _ZWSCN_DEVICE_REPORT_CACHE_H_
#define _ZWSCN_DEVICE_REPORT_CACHE_H_

/** @defgroup GroupPrivateReportCache Device Report Cache
 *  Functions for handling Device Report Cache
 *  @ingroup GroupPrivateGeneral
 */
///@{

/**
 * @brief	Add a report to Device Report Cache
...
/**
 * @brief	Delete Device Report Cache for a given id
 * @param[in] net			Network runtime context
 * @param[in] id			Report id
 */
void zwscn_device_report_cache_del(void *net, uint32_t id);
/**
 * @brief	Check if Device Report Cache is fresh for a given id
 * @param[in] net			Network runtime context
 * @param[in] id			Report id
 * @return					ZWSCN_BOOL_T (TRUE or FALSE)
 */
ZWSCN_BOOL_T zwscn_device_report_cache_is_fresh(void *net, uint32_t id);
///@}

#endif //_ZWSCN_DEVICE_REPORT_CACHE_H_
