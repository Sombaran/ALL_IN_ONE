...
*/
#ifndef _ZWSCN_ZWPOLL_H_
#define _ZWSCN_ZWPOLL_H_  

/** @defgroup GroupPrivateZWPoll ZWPoll functions
 *  Functions for ZWPoll
...
/**
 * @brief	Reset the pending Report counter
 * @param[in] net		Network runtime context
...
/**
 * @brief	Get ZWPoll request token for input Action
 * @param[in] action_ptr	Action pointer
 * @return	ZWPoll request token
 */
uint32_t 					zwscn_zwpoll_get_token(zwscn_action_p action_ptr);
/**
 * @brief	Get ZWPoll request interval for input Action
 * @param[in] action_ptr	Action pointer
 * @return	ZWPoll request interval
 */
uint16_t 					zwscn_zwpoll_get_interval(zwscn_action_p action_ptr);
/**
 * @brief	Get ZWPoll request count for input Action
 * @param[in] action_ptr	Action pointer
 * @return	ZWPoll request count
 */
uint16_t 					zwscn_zwpoll_get_count(zwscn_action_p action_ptr);
///@}

#endif // _ZWSCN_ZWPOLL_H_
