...
*/
/**
@file		zwscn_security_scene_notifications.h  
...
*/
#ifndef _ZWSCN_SCENE_SECURITY_SCENE_NOTIFICATION_H_
#define _ZWSCN_SCENE_SECURITY_SCENE_NOTIFICATION_H_

/** @defgroup GroupPrivateSecuritySceneNotifications Security Scene Notifications
 *  Functions for sending Security Scene Notifications
 *  @ingroup GroupPrivateGeneral
 */
///@{

/**
 * @brief	Send Security Scene Notification request
 * @param[in] net			Network runtime context
 * @param[in] scene_ptr		Security Scene pointer
 * @param[in] message_type	Message type (e.g. ZWSCN_MESSAGE_TYPE_SECURITY_SCENE_NOTIFICATION_SEND)
...
/**
 * @brief	Thread for receiving Security Scene Notification requests
...
/**
 * @brief	Get string representation for the event trigger
 * @param[in] net				Network runtime context
 * @param[in] event				Trigger event
 * @param[out] output_buf		Buffer to store output string
...
#endif // _ZWSCN_SCENE_SECURITY_SCENE_NOTIFICATION_H_
