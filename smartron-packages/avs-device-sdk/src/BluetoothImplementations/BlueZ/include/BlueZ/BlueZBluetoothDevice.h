...
#define BLUEZ_SINK "bluez_sink"
#define ALSA_SINK "alsa_output.0"
#define BLUEZ_CARD "bluez_card."
...
#define SIZE_64 64
#define SIZE_128 128
#define SIZE_OF_MAC 17

namespace alexaClientSDK {
namespace bluetoothImplementations {
namespace blueZ {

// Redmine 21119: Start: Callback for getting Device property
int bluez_device_call_method(const gchar *, const gchar *, const gchar *, const char **);

// Callback for External speaker routing
char *execute_speaker_route();

// Callback for Updating Last connected device mac addr and status
void connected_list_write(const char *mac_addr_char, char *status);

// Callback for Reading Last connected device mac addr and status
void connected_list_read (char *mac_addr, char *status);

// Callback for converting MacAddress to Object_path
...
public:
    ...
    /** Redmine 21470: Start: 
     *  A function for MediaPlayer to disconnect the Last Connected device, This is overcome the issue of Dual audio playback
     *  with Cloud and Bluetooth
     */
    static bool shifu_last_bt_disconnect();
    // Redmine 21470: End

    /** Redmine 22146: Start:
     * Updates the connection status of specific device
     */
    void ConnectionTranistionStateUpdate();
    // Redmine 22146: End
