...
// Redmine 21425: Start: Converting variant into guint16 type
bool GVariantMapReader::getUint16(const char* name, guint16* value) const {
    if (nullptr == m_map) {
        ACSDK_ERROR(LX("getInt32Failed").d("reason", "m_map is null"));
        return false;
    }
    ...
    return g_variant_lookup(m_map, name, "q", value) != 0;
}
// Redmine 21425: End
