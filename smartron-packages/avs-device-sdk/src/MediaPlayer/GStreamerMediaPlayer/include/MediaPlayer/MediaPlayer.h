...
public:
    ...
    /** fix for 21360 **/
	bool isMediaActive(SourceId id) override;

    /** fix for 21208 **/
    bool setActualVolume(SourceId id) override;
    bool setLowVolume(SourceId id) override;
    ...
    int get_volume_to_float_index(gdouble gstVolume);
    int get_volume_led(int);
    double get_volume_index(void);
    /// @}
...
private:
    ...
    /* #21219
    * Adding below variables to know about the player 
    */  
    ///varible to store particular player name.
    std::string PlayerName;

    /* Redmine 21137: Start:
    *  Variable to differentiate Players
    */
    uint8_t PlayerId; 
};
