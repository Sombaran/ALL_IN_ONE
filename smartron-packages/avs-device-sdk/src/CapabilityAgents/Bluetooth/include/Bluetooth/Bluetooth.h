...
private:
    ...
    /// Send a Volume Changed when the Property is changed
    void executeVolumeChanged(uint16_t volume); 
    ...
    // // Redmine 21156: Start: Declaration of shifu_prev_stream_state variable to store previous stream state.    
    // StreamingState shifu_prev_stream_state;
    // // Redmine 21156: End
