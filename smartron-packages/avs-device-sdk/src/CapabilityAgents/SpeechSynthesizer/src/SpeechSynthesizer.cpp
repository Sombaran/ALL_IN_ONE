 ...
 * */
bool SpeechSynthesizer::isSpeakingActive() {
    if (m_currentState == SpeechSynthesizerObserverInterface::SpeechSynthesizerState::PLAYING) {
        return true;
    }else {
        return false;
    }
 ...
 * */
/** BUG:21972
 *  Adding stop Speaking to stop the Dialogue if currently running suddenly internet disconnected.
 **/
