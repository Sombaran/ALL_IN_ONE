...
TEST_F(SpeakerManagerTest, testNullContextManager) {
    ...
    m_speakerManager = SpeakerManager::create(speakers, nullptr, m_mockMessageSender, m_mockExceptionSender, m_focusManager);
...
TEST_F(SpeakerManagerTest, testNullMessageSender) {
    ...
    m_speakerManager = SpeakerManager::create(speakers, m_mockContextManager, nullptr, m_mockExceptionSender, m_focusManager);
...
TEST_F(SpeakerManagerTest, testNullExceptionSender) {
    ...
    m_speakerManager = SpeakerManager::create(speakers, m_mockContextManager, m_mockMessageSender, nullptr, m_focusManager);
...
TEST_F(SpeakerManagerTest, testNoSpeakers) {
    m_speakerManager = SpeakerManager::create({}, m_mockContextManager, m_mockMessageSender, m_mockExceptionSender, m_focusManager);
...
TEST_F(SpeakerManagerTest, testContextManagerSetStateConstructor) {
    ...
    m_speakerManager =
        SpeakerManager::create(speakers, m_mockContextManager, m_mockMessageSender, m_mockExceptionSender, m_focusManager);
}
...
TEST_F(SpeakerManagerTest, testGetConfiguration) {
    ...
    m_speakerManager =
        SpeakerManager::create({speaker}, m_mockContextManager, m_mockMessageSender, m_mockExceptionSender, m_focusManager);
