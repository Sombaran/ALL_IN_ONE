...
protected:
    ...
    /* #21139:This variable is used to access FocusManagerInterface to know about active channels. */
...
void DoNotDisturbCapabilityAgentTest::SetUp() {
    ...
    /* #21139:Adding FocusManagerInterface  object to know about active channels. */
    m_dndCA = DoNotDisturbCapabilityAgent::create(
        m_customerDataManager, m_mockExceptionEncounteredSender, m_messageSender, m_settingsManager, m_settingsStorage, m_focusManager);
...
TEST_F(DoNotDisturbCapabilityAgentTest, givenNullCustomerDataManager_create_shouldFail) {
    auto dndCA = DoNotDisturbCapabilityAgent::create(
        nullptr, m_mockExceptionEncounteredSender, m_messageSender, m_settingsManager, m_settingsStorage, m_focusManager);
...
TEST_F(DoNotDisturbCapabilityAgentTest, givenNullExceptionSender_create_shouldFail) {
    auto dndCA = DoNotDisturbCapabilityAgent::create(
        m_customerDataManager, nullptr, m_messageSender, m_settingsManager, m_settingsStorage, m_focusManager);
    EXPECT_THAT(dndCA, IsNull());
}
...
TEST_F(DoNotDisturbCapabilityAgentTest, givenNullMessageSender_create_shouldFail) {
    auto dndCA = DoNotDisturbCapabilityAgent::create(
        m_customerDataManager, m_mockExceptionEncounteredSender, nullptr, m_settingsManager, m_settingsStorage, m_focusManager);
    EXPECT_THAT(dndCA, IsNull());
}
...
TEST_F(DoNotDisturbCapabilityAgentTest, givenNullSettingsManager_create_shouldFail) {
    auto dndCA = DoNotDisturbCapabilityAgent::create(
        m_customerDataManager, m_mockExceptionEncounteredSender, m_messageSender, nullptr, m_settingsStorage, m_focusManager);
    EXPECT_THAT(dndCA, IsNull());
}
...
TEST_F(DoNotDisturbCapabilityAgentTest, givenNullSettingsStorage_create_shouldFail) {
    auto dndCA = DoNotDisturbCapabilityAgent::create(
        m_customerDataManager, m_mockExceptionEncounteredSender, m_messageSender, m_settingsManager, nullptr, m_focusManager);
    EXPECT_THAT(dndCA, IsNull());
}
