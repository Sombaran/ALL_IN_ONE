...
public:
    ...
    */
    /// Varible to know the state of player as playing or not.
    bool IsPlayerActive;
	...
	/** fix for 21360 **/
	virtual bool isMediaActive(SourceId id) = 0;

	/** fix for 21208 **/
	virtual bool setActualVolume(SourceId id) = 0;
	virtual bool setLowVolume(SourceId id) = 0;
