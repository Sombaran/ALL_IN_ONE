...
public:
    ...
    /* #21158: this function is implemented by smartron based on the above microphoneToggle() api. When the microphone is on, 
    * AVS starts audio data from microphone.*/
    void microphoneOn();
    
    /* #21158: this function is implemented by smartron based on the above microphoneToggle() api. When the microphone is off, 
    * AVS stops audio data from microphone. Note however that hold-to-talk and tap-to-talk modes will still work by recording
    * microphone data temporarily until a user initiated interacion is complete.*/    
    void microphoneOff();
    ...
    /* #21219
    * get the priority od active channel running
    */
