...
using namespace alexaClientSDK::defaultClient;
...
int main(int argc, char* argv[]) {
    ...
    std::string logLevel;
    ConsolePrinter::simplePrint("Alexa Service Initiated");
    ...
    /* creating socket to interact with led-server*/
    alexaClientSDK::avsCommon::utils::led::led_client_init();
    ...
    */
	signal(SIGUSR1,DefaultClient::network_connected);
	signal(SIGUSR2,DefaultClient::network_disconnected);
    ...
    do {
        ...
        returnCode = sampleApplication->run(false);
       // while(true)
        //{
        	/* create a connection-interfcae with different modules in place of sleep call */
        //	sleep(1);
       // }
