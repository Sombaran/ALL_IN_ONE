...
/*#20994 Start: adding variables for app based registration*/
    /// State of ZMQ context 0: no context, 1: context already exist
    bool IsLwaZMQcontext;
    
    /// Verification code received from mobile App
    std::string m_authCode;
    
    /// Code challenge received from mobile App
    std::string m_codeVerifier;
    
    ///Redirection URI received from mobile App
    std::string m_redirectURI;
    
    /// Client id received from mobile App
    ...
    /// ZMQ socket
    void *LwaZmqResponder;
/*#20994 End: adding variables for app based registration*/
};
